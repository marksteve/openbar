...
// Since msr doesn't play well with browserify's require, let's just
// copy the JS file and manually export to window (not sure if there
// are options in browserify to avoid doing it like this). We can't
// use exports since this module manually checks for window.
window.MediaStreamRecorder = MediaStreamRecorder;
window.MediaRecorderWrapper = MediaRecorderWrapper;
window.StereoRecorder = StereoRecorder;
window.StereoAudioRecorder = StereoAudioRecorder;
window.WhammyRecorderHelper = WhammyRecorderHelper;
window.WhammyRecorder = WhammyRecorder;
window.Whammy = Whammy;
window.GifRecorder = GifRecorder;
window.MultiStreamRecorder = MultiStreamRecorder;
